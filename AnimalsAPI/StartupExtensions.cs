...
public static class StartupExtensions
{
    public static WebApplication ConfigureServices(this WebApplicationBuilder builder)
    {
        ...
        {
            options.SwaggerDoc("AnimalsOpenAPISpecification", new()
            {
                Title = "Animals API",
                Version = "1",
                Description = "Through this API you can access animals."
            });
        ...
        builder.Services.AddDbContext<AnimalsDbContext>(opt =>
        {
            var databaseConnectionString = builder.Configuration.GetConnectionString("AnimalsDatabase") ?? throw new InvalidOperationException("Connection string 'AnimalsDatabase' not found.");
    ...
    public static WebApplication ConfigurePipeline(this WebApplication app)
    {
        if (app.Environment.IsDevelopment())
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/AnimalsOpenAPISpecification/swagger.json", "Animals API");
            });
        }
